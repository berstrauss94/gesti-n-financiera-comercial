...
- [ ] 1. Modelos de datos, esquemas y estructura base
  - [ ] 1.1 Crear modelo OwnerWithdrawal y actualizar modelo Salary
  ...
  - [ ] 1.2 Crear modelo ThresholdConfig con defaults
  ...
  - [ ] 1.5 Crear schemas Marshmallow para validación
...
- [ ] 2. Checkpoint - Foundation
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Autenticación, sesiones y multi-tenant
  - [ ] 3.1 Implementar registro de usuario con validaciones completas
  ...
  - [ ] 3.2 Implementar login con lockout y manejo de sesión
  ...
  - [ ] 3.3 Implementar expiración de sesión por inactividad
  ...
  - [ ] 3.4 Implementar módulo de negocios y selección multi-tenant
...
- [ ] 4. Checkpoint - Auth & Multi-tenant
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Módulo de Ingresos
  - [ ] 5.1 Implementar CRUD de ingreso bruto diario
  ...
  - [ ] 5.2 Implementar recálculo de indicadores al guardar ingreso
...
- [ ] 6. Módulo de Gastos y Costos
  - [ ] 6.1 Implementar CRUD de salarios de empleados
  ...
  - [ ] 6.2 Implementar CRUD de retiros del dueño
  ...
  - [ ] 6.3 Implementar CRUD de gastos variables (8 categorías)
  ...
  - [ ] 6.4 Implementar CRUD de costos operativos
...
- [ ] 7. Heatmap Service
  - [ ] 7.1 Implementar algoritmo de cálculo de color heatmap
  ...
  - [ ] 7.2 Implementar cálculo de todos los indicadores por día
  ...
  - [ ] 7.3 Implementar panel de ganancia neta
  ...
  - [ ] 7.4 Crear endpoints REST del heatmap
...
- [ ] 8. Checkpoint - Core Financial Logic
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Motor de Machine Learning
  - [ ] 9.1 Implementar cálculo de promedio móvil
  ...
  - [ ] 9.2 Implementar lógica de recalibración
  ...
  - [ ] 9.3 Implementar predicción con intervalo de confianza
  ...
  - [ ] 9.4 Crear endpoints REST del ML engine
...
- [ ] 10. Checkpoint - ML Engine
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Módulo de Reportes
  - [ ] 11.1 Implementar generación de reportes por período
  ...
  - [ ] 11.2 Implementar comparativa entre períodos
  ...
  - [ ] 11.3 Implementar filtro de texto en reportes
  ...
  - [ ] 11.4 Implementar exportación PDF y CSV
...
- [ ] 12. Checkpoint - Reports
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 13. CI/CD y configuración de despliegue
  - [ ] 13.1 Crear pipeline GitHub Actions para CI
  ...
  - [ ] 13.2 Configurar despliegue automático a Railway
